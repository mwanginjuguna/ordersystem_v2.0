        ...
        <template v-slot:default>
            <div class="">
                ...
                <div class="grid sm:grid-cols-3 mt-3 gap-y-3 px-4 md:px-8">
                    <div class="w-fit p-2 px-4 grid grid-cols-3 gap-x-2 bg-purple-600 hover:bg-purple-700 rounded-md transition-all duration-150 ease-in-out">
                        <svg width="44px" height="44px" class="place-self-center" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M18.5 5.5H11.5V12.5H18.5V5.5ZM10 4V14H20V4H10Z" fill="#fecdd3"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M7 8H8.5V15.5H16V17H7V8Z" fill="#fecdd3"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M4 11H5.5V18.5H13V20H4V11Z" fill="#fecdd3"></path> </g>
                        </svg>
                        <div class="col-span-2 pl-2">
                            <p class="text-xl lg:text-3xl font-bold text-slate-100">{{ orders.length }}</p>
                            <h2 class="mt-px text-slate-300 text-sm font-semibold">Total Orders</h2>
                        </div>
                    </div>

                    <div class="w-fit p-2 px-4 grid grid-cols-3 gap-x-2 bg-purple-600 hover:bg-purple-700 rounded-md transition-all duration-150 ease-in-out">
                        <svg width="44px" height="44px" class="place-self-center" viewBox="0 0 64 64" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path fill="#274c77" class="cls-4" d="M46.2,32c0-.9,.3-1.72,.8-2.4-.36-2.14-1.2-4.11-2.4-5.81-.83-.13-1.63-.49-2.26-1.13s-1.01-1.44-1.13-2.26c-1.7-1.2-3.67-2.04-5.81-2.4-.67,.5-1.5,.8-2.4,.8s-1.72-.3-2.4-.8c-2.14,.36-4.11,1.2-5.81,2.4-.13,.83-.49,1.63-1.13,2.26s-1.44,1.01-2.26,1.13c-1.2,1.7-2.04,3.67-2.4,5.81,.5,.67,.8,1.5,.8,2.4s-.3,1.72-.8,2.4c.36,2.14,1.2,4.11,2.4,5.81,.83,.13,1.63,.49,2.26,1.13,.64,.64,1.01,1.44,1.13,2.26,1.7,1.2,3.67,2.04,5.81,2.4,.67-.5,1.5-.8,2.4-.8s1.72,.3,2.4,.8c2.14-.36,4.11-1.2,5.81-2.4,.13-.83,.49-1.63,1.13-2.26,.64-.64,1.44-1.01,2.26-1.13,1.2-1.7,2.04-3.67,2.4-5.81-.5-.67-.8-1.5-.8-2.4Z"></path><circle fill="#fa7900" cx="33" cy="32" r="9"></circle><path fill="#fecdd3" d="M7,32c0-14.36,11.64-26,26-26v4c-12.15,0-22,9.85-22,22"></path><polygon fill="#fde047" points="9 38 5 32 13 32 9 38"></polygon><path fill="#fecdd3" d="M46,54.51c-12.44,7.18-28.34,2.92-35.52-9.52l3.46-2c6.08,10.52,19.53,14.13,30.05,8.05"></path><polygon fill="#fde047" points="50.19 49.78 47 56.25 43 49.32 50.19 49.78"></polygon><path fill="#fecdd3" d="M46,9.48c12.44,7.18,16.7,23.08,9.52,35.52l-3.46-2c6.08-10.52,2.47-23.98-8.05-30.05"></path><polygon fill="#fde047" points="39.8 8.21 47 7.75 43 14.68 39.8 8.21"></polygon></g>
                        </svg>
                        <div class="col-span-2 pl-2">
                            <p class="text-xl lg:text-3xl font-bold text-slate-100">{{ running }}</p>
                            <h2 class="mt-px text-slate-300 text-sm font-semibold">In-Progress</h2>
                        </div>
                    </div>

                    <div class="w-fit p-2 px-4 grid grid-cols-3 gap-x-2 bg-purple-600 hover:bg-purple-700 rounded-md transition-all duration-150 ease-in-out">
                        <svg width="44px" height="44px" class="place-self-center" viewBox="0 0 64 64" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><title></title><path class="fill-[#fecdd3]" d="M28.46,42.29A2,2,0,0,1,27,41.71l-9.5-9.5a2,2,0,0,1,2.83-2.83l8.09,8.09L43.63,22.29a2,2,0,1,1,2.83,2.83L29.87,41.71A2,2,0,0,1,28.46,42.29Z"></path><path class="fill-[#fecdd3]" d="M32,60A28,28,0,1,1,60,30.47a2,2,0,0,1-1.88,2.11A2,2,0,0,1,56,30.69,24,24,0,1,0,39.64,54.75,23.86,23.86,0,0,0,53.58,42.51a2,2,0,1,1,3.59,1.75A27.78,27.78,0,0,1,40.91,58.55,28.14,28.14,0,0,1,32,60Z"></path></g>
                        </svg>
                        <div class="col-span-2 pl-2">
                            <p class="text-xl lg:text-3xl font-bold text-slate-100">{{ completed }}</p>
                            <h2 class="mt-px text-slate-300 text-sm font-semibold">Completed</h2>
                        </div>
                    </div>
                </div>
