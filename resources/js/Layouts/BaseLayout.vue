    ...
    <div>
        <div class="relative min-h-screen bg-white">
            ...
            <div class="grid md:grid-cols-5">
                <!-- Sidebar here -->
                <aside :class="{ block: showingSidebar, hidden: !showingSidebar }" class="md:block relative col-span-4 md:col-span-1 text-slate-900 bg-slate-100 min-h-screen p-4 lg:pl-5 scroll-auto overflow-y-auto pb-6 text-xs md:text-sm lg:text-base">
                    <Sidebar />
                </aside>
                ...
                <div class="col-span-4 h-screen overflow-y-auto">
                    <nav class="sticky top-0 right-0 z-10 text-white bg-slate-100 border-b border-gray-100">
                    ...
                    <div class="lg:border-l">
                        <!-- Page Heading -->
                        <header v-if="$slots.header" class="my-4">
